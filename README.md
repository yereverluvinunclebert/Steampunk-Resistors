...
Steampunk Resistors widget, written in Javascript and XML for the Yahoo 
...
This widget is an attractive steampunk Yahoo widget for your desktop. 
It is a simple resistor calculator. A resistor calculator displays numeric 
electrical resistance values using the colour bands on a typical electronic 
resistor when the values are entered sequentially. Functional and gorgeous at 
